...
QT_MOC_LITERAL(3, 24, 18), // "processTextMessage"
QT_MOC_LITERAL(4, 43, 7), // "message"
QT_MOC_LITERAL(5, 51, 18), // "socketDisconnected"
QT_MOC_LITERAL(6, 70, 19), // "sendMessageToOthers"
QT_MOC_LITERAL(7, 90, 20) // "addMessageToDatabase"

    },
    "socket\0onNewConnection\0\0processTextMessage\0"
    "message\0socketDisconnected\0"
    "sendMessageToOthers\0addMessageToDatabase"
};
...
void socket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->sendMessageToOthers((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 4: _t->addMessageToDatabase((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}
